...
import frc.robot.subsystems.GenericSwerveDrive;
import frc.robot.subsystems.SwerveDrive;

import java.util.function.Supplier;


public class GenericSwerveController extends Command{

    private final GenericSwerveDrive m_subsystem;
    ...
    public GenericSwerveController(GenericSwerveDrive subsystem, Supplier<Double> xspeed, Supplier<Double> yspeed,
