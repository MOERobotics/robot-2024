...
public class DriveToNoteCommandFixedSpeed extends Command {
    ...
    private final double fixedSpeed = 0.5;

    private Boolean end = false;

    /*public DriveToNoteCommandFixedSpeed(SwerveDrive subsystem, Vision vision) {
        this(subsystem, vision, null);
    }*/

    public DriveToNoteCommandFixedSpeed(SwerveDrive subsystem, Vision vision, DoubleConsumer rumbleCallback){
        this.vision = vision;
