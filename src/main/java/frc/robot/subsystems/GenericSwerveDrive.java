...
public class GenericSwerveDrive extends SubsystemBase {
    GenericSwerveModule FLModule;
    GenericSwerveModule BLModule;
    GenericSwerveModule FRModule;
    GenericSwerveModule BRModule;
    WPI_Pigeon2 pigeon;
	...
	private final TimeInterpolatableBuffer<Pose2d> BufferedPose;
    public GenericSwerveDrive(GenericSwerveModule FLModule, GenericSwerveModule BLModule, GenericSwerveModule FRModule, GenericSwerveModule BRModule,
